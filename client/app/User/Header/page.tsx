...
export default function Header() {
  ...
  const coinCount = localStorage.getItem("userOrderCount");
  ...
  const imageUrl = userFromLocalStorage
    ? `${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}/${JSON.parse(userFromLocalStorage).profileImage
    }`
    : "/user.png";
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                        ...
                        {login &&
                          navigation.map((item) => (
                            <a
                              ...
                              href={item.href}
                              className={`rounded-md px-3 py-2 text-sm font-medium ${item.name === currentItem
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="hidden md:block">
                      <div className="ml-4 w-20 flex items-center md:ml-6">
                        <button
                          type="button"
                          ...
                          <div>
                            <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                              ...
                              <img
                                ...
                                // src={`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}/${imageUrl}`}
                                src={imageUrl}
                                alt="user Image"
                              />
                            </Menu.Button>
